/**
 * New Subscription Welcome Email Template
 */
function getSubscriptionWelcomeTemplate(license, amount, frontendUrl, supportEmail) {
    return `
    <!DOCTYPE html>
    <html>
    <head>
        <meta charset="utf-8">
        <title>Welcome to JCS Photo Suite!</title>
    ...
    <body style="font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; line-height: 1.6; color: #333; margin: 0; padding: 0; background-color: #f5f5f5;">
        <div style="max-width: 600px; margin: 0 auto; background-color: white; box-shadow: 0 4px 6px rgba(0, 0, 0, 0.1);">
            ...
            <div style="background: linear-gradient(135deg, #2563eb, #3b82f6); color: white; padding: 30px 20px; text-align: center; border-radius: 8px 8px 0 0;">
                <h1 style="margin: 0; font-size: 28px; font-weight: bold;">🎉 Welcome to JCS Photo Suite!</h1>
                <p style="margin: 10px 0 0 0; font-size: 18px; opacity: 0.9;">Your ${license.plan_tier} license is now active</p>
            </div>
            
            <!-- Content -->
            <div style="padding: 30px 20px;">
                <h2 style="color: #2563eb; margin-top: 0;">Hi ${license.first_name}! 🚀</h2>
                <p style="font-size: 16px; margin-bottom: 25px;">Thank you for choosing JCS Photo Suite! Your payment was successful and your license is now active. You're all set to revolutionize photo management at ${license.district_name}.</p>
                ...
                <div style="background: #eff6ff; border: 2px solid #2563eb; border-radius: 8px; padding: 20px; margin: 25px 0;">
                    ...
                    <table style="width: 100%; border-collapse: collapse;">
                        ...
                        <tr><td style="padding: 8px 0; font-weight: bold; color: #374151;">Amount Paid:</td><td style="padding: 8px 0; color: #2563eb; font-weight: bold;">$${amount}</td></tr>
