 ...
 */
function getSubscriptionCancelledTemplate(license, frontendUrl, supportEmail) {
    return `
    <!DOCTYPE html>
    <html>
    <head>
    ...
    <body style="font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; line-height: 1.6; color: #333; margin: 0; padding: 0; background-color: #f5f5f5;">
        <div style="max-width: 600px; margin: 0 auto; background-color: white; box-shadow: 0 4px 6px rgba(0, 0, 0, 0.1);">
            ...
            <div style="background: linear-gradient(135deg, #dc2626, #ef4444); color: white; padding: 30px 20px; text-align: center; border-radius: 8px 8px 0 0;">
                <h1 style="margin: 0; font-size: 28px; font-weight: bold;">😔 Subscription Cancelled</h1>
                <p style="margin: 10px 0 0 0; font-size: 18px; opacity: 0.9;">Your JCS Photo Suite subscription has been cancelled</p>
            </div>
            
            <!-- Content -->
            <div style="padding: 30px 20px;">
                <h2 style="color: #dc2626; margin-top: 0;">Hi ${license.first_name},</h2>
                <p style="font-size: 16px; margin-bottom: 25px;">Your JCS Photo Suite subscription for ${license.district_name} has been cancelled. Your license will expire on ${new Date(license.expiry_date).toLocaleDateString('en-US', { year: 'numeric', month: 'long', day: 'numeric' })}.</p>
