/**
 * 30-Day Expiry Warning Email Template
 */
function get30DayExpiryTemplate(license, daysLeft, frontendUrl, supportEmail) {
    return `
    <!DOCTYPE html>
    <html>
    <head>
    ...
    <body style="font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; line-height: 1.6; color: #333; margin: 0; padding: 0; background-color: #f5f5f5;">
        <div style="max-width: 600px; margin: 0 auto; background-color: white; box-shadow: 0 4px 6px rgba(0, 0, 0, 0.1);">
            ...
            <div style="background: linear-gradient(135deg, #2563eb, #3b82f6); color: white; padding: 30px 20px; text-align: center; border-radius: 8px 8px 0 0;">
                <h1 style="margin: 0; font-size: 28px; font-weight: bold;">📅 License Renewal Reminder</h1>
            ...
            <div style="padding: 30px 20px;">
                ...
                <p style="font-size: 16px; margin-bottom: 25px;">Your JCS Photo Suite license for ${license.district_name} is set to expire on ${new Date(license.expiry_date).toLocaleDateString('en-US', { year: 'numeric', month: 'long', day: 'numeric' })}. Please ensure your payment is up to date to avoid any interruption in service.</p>
                ...
                <div style="text-align: center; margin: 30px 0;">
                    <a href="${frontendUrl}/dashboard/billing" style="background: #2563eb; color: white; padding: 15px 30px; text-decoration: none; border-radius: 6px; font-weight: bold; display: inline-block; font-size: 16px; margin: 10px; box-shadow: 0 2px 4px rgba(37, 99, 235, 0.3);">Renew License Now</a>
                </div>
